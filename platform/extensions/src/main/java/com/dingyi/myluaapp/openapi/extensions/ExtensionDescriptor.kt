...
class ExtensionDescriptor(
    ...
    lateinit var rawDescriptor: ExtensionsImplementationBuilder
...
class ExtensionPointDescriptor(
    ...
    fun getQualifiedName(pluginDescriptor: PluginDescriptor) =
        if (isNameQualified) name else "${pluginDescriptor.pluginId}.$name"
    ...
    lateinit var rawDescriptor: ExtensionPointBuilder
