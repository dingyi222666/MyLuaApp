 ...
 * @author dsl
 */
interface ModuleFileIndex : FileIndex {
    /**
     ...
     */
    fun getOrderEntryForFile(fileOrDir: VirtualFile): OrderEntry?
     ...
     */
    fun getOrderEntriesForFile(fileOrDir: VirtualFile): List<OrderEntry?>
}