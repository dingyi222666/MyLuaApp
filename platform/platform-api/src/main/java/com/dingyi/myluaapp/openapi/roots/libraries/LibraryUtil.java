...
import com.dingyi.myluaapp.openapi.roots.OrderEnumerator;
...
public final class LibraryUtil {
  ...
  public static VirtualFile @NotNull [] getLibraryRoots(@NotNull Project project, final boolean includeSourceFiles, final boolean includeJdk) {
    return getLibraryRoots(ModuleManager.Companion.getInstance(project).getModules(), includeSourceFiles, includeJdk);
  }
