...
public class MyLuaAppLogRecordFormatter extends Formatter {
  ...
  public MyLuaAppLogRecordFormatter() {
    this(true);
  }

  public MyLuaAppLogRecordFormatter(boolean withDateTime) {
    this(withDateTime, null);
  }

  public MyLuaAppLogRecordFormatter(boolean withDateTime, @Nullable MyLuaAppLogRecordFormatter copyFrom) {
