...
//						//-----------
			...
			try
			{
				...
				while (!_abort.isSet())
				{
					...
					String name1=lexer. yytext().toString();
					...
					if (lastName.equals("class") || lastName.equals("long") || lastName.equals("int") || lastName.equals("short") || lastName.equals("byte") || lastName.equals("float") || lastName.equals("double") || lastName.equals("char") || lastName.equals("boolean"))
					{
					...
					//mythoi改，支持// /*注释
					/*TextUtilKt.showDebugText(lastName+" "+name1);
					if (lastName.equals("//") ) {
					...
					{		
						 ...
						 */
						String name= (String) lexer.yytext();
