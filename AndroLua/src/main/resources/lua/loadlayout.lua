...
local function setattribute(root, view, params, k, v, ids)
    ...
    elseif k == "subTitleTextAppearance" then
        view.setSubtitleTextAppearance(context, checkattr(v))
    elseif k == "titleTextAppearance" then
        view.setTitleTextAppearance(context, checkattr(v))
    ...
    elseif k == "src" then
        ...
        elseif v:find("^https?://") then
            task([[require "import" url=... return loadbitmap(url)]], v, function(bmp)
        ...
        elseif type(v) == "string" then
            if ltrs[v] then
                ...
                elseif type(l) == "userdata" then
                    ...
                    listener = OnClickListener { onClick = function(a)
                        (root[v] or _G[v])(a)
                    end }
                end
                ltrs[v] = listener
