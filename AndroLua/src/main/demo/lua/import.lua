...
if (activity.getPackageName() == "com.dingyi.MyLuaApp") then
  _G['R'] = bindClass("com.dingyi.MyLuaApp.R")
else
  local selfR=bindClass(activity.getPackageName()..".R")
  if selfR~=nil then
    _G['R']=selfR
  else
    _G['R']=bindClass("com.androlua.R")
  end
end
...
local NIL = {}
setmetatable(NIL, { __tostring = function()
  return "nil"
end })
