...
class LuaParser(input: TokenStream) : Parser(input) {
    ...
    companion object {
        ...
        val ruleNames = arrayOf(
            "chunk", "block", "stat", "comment", "ifbody",
    ...
    open class IfStatContext : StatContext {
        ...
        fun findElseifbody(): List<ElseifbodyContext> =
            getRuleContexts(solver.getType("ElseifbodyContext"))

        fun findElseifbody(i: Int): ElseifbodyContext? =
            getRuleContext(solver.getType("ElseifbodyContext"), i)
    ...
    open class SwitchStatContext : StatContext {
        fun findExp(): ExpContext? = getRuleContext(solver.getType("ExpContext"), 0)
        fun findCasebody(): List<CasebodyContext> =
            getRuleContexts(solver.getType("CasebodyContext"))

        fun findCasebody(i: Int): CasebodyContext? =
            getRuleContext(solver.getType("CasebodyContext"), i)

        fun findDefaultbody(): DefaultbodyContext? =
            getRuleContext(solver.getType("DefaultbodyContext"), 0)
    ...
    open class WhenStatContext : StatContext {
        fun findExp(): ExpContext? = getRuleContext(solver.getType("ExpContext"), 0)
        fun findPrefixexp(): List<PrefixexpContext> =
            getRuleContexts(solver.getType("PrefixexpContext"))

        fun findPrefixexp(i: Int): PrefixexpContext? =
            getRuleContext(solver.getType("PrefixexpContext"), i)
    ...
    open class FunctionCallStatContext : StatContext {
        fun findFunctioncall(): FunctioncallContext? =
            getRuleContext(solver.getType("FunctioncallContext"), 0)
        ...
        override fun <T> accept(visitor: ParseTreeVisitor<out T>): T {
            if (visitor is LuaVisitor) return (visitor as LuaVisitor<out T>).visitFunctionCallStat(
                this
            )
            else return visitor.visitChildren(this)!!
        }
    ...
    open class LocalFunctionDefStatContext : StatContext {
        ...
        override fun <T> accept(visitor: ParseTreeVisitor<out T>): T {
            if (visitor is LuaVisitor) return (visitor as LuaVisitor<out T>).visitLocalFunctionDefStat(
                this
            )
            else return visitor.visitChildren(this)!!
        }
    ...
    open class LambdaStatContext : StatContext {
        fun findLambdabody(): LambdabodyContext? =
            getRuleContext(solver.getType("LambdabodyContext"), 0)
    ...
    open class LocalVarListStatContext : StatContext {
        fun findAttnamelist(): AttnamelistContext? =
            getRuleContext(solver.getType("AttnamelistContext"), 0)
        ...
        override fun <T> accept(visitor: ParseTreeVisitor<out T>): T {
            if (visitor is LuaVisitor) return (visitor as LuaVisitor<out T>).visitLocalVarListStat(
                this
            )
            else return visitor.visitChildren(this)!!
        }
    ...
    open class FunctionDefStatContext : StatContext {
        ...
        override fun <T> accept(visitor: ParseTreeVisitor<out T>): T {
            if (visitor is LuaVisitor) return (visitor as LuaVisitor<out T>).visitFunctionDefStat(
                this
            )
            else return visitor.visitChildren(this)!!
        }
    ...
    fun stat(): StatContext {
        ...
        try {
            ...
            when (interpreter!!.adaptivePredict(_input!!, 14, context)) {
                1 -> {
                    _localctx = NilContext(_localctx)
                    enterOuterAlt(_localctx, 1)
                    if (true) {
                        this.state = 104
                        match(T__0) as Token
                ...
                2 -> {
                    _localctx = VarListStatContext(_localctx)
                ...
                3 -> {
                    _localctx = FunctionCallStatContext(_localctx)
                ...
                4 -> {
                    _localctx = LabelStatContext(_localctx)
                ...
                5 -> {
                    _localctx = BreakStatContext(_localctx)
                ...
                6 -> {
                    _localctx = ContinueStatContext(_localctx)
                ...
                7 -> {
                    _localctx = GotoStatContext(_localctx)
                ...
                8 -> {
                    _localctx = DoStatContext(_localctx)
                ...
                9 -> {
                    _localctx = WhileStatContext(_localctx)
                ...
                10 -> {
                    _localctx = RepeatStatContext(_localctx)
                ...
                11 -> {
                    _localctx = IfStatContext(_localctx)
                ...
                12 -> {
                    _localctx = ForStatContext(_localctx)
                ...
                13 -> {
                    _localctx = ForInStatContext(_localctx)
                ...
                14 -> {
                    _localctx = FunctionDefStatContext(_localctx)
                ...
                15 -> {
                    _localctx = LocalFunctionDefStatContext(_localctx)
                ...
                16 -> {
                    _localctx = LocalVarListStatContext(_localctx)
                ...
                17 -> {
                    _localctx = SwitchStatContext(_localctx)
                ...
                18 -> {
                    _localctx = WhenStatContext(_localctx)
                ...
                19 -> {
                    _localctx = LambdaStatContext(_localctx)
                ...
                20 -> {
                    _localctx = DeferStatContext(_localctx)
                ...
                21 -> {
                    _localctx = ReturnStatContext(_localctx)
                ...
                22 -> {
                    _localctx = CommentStatContext(_localctx)
    ...
    open class RetstatContext : ParserRuleContext {
        ...
        fun findComment(i: Int): CommentContext? =
            getRuleContext(solver.getType("CommentContext"), i)
    ...
    open class FuncnameContext : ParserRuleContext {
        ...
        fun NAME(): List<TerminalNode> = getTokens(LuaParser.Tokens.NAME.id)
        fun NAME(i: Int): TerminalNode = getToken(LuaParser.Tokens.NAME.id, i) as TerminalNode
        fun findFuncname_self(): Funcname_selfContext? =
            getRuleContext(solver.getType("Funcname_selfContext"), 0)
    ...
    open class ExpContext : ParserRuleContext {
        ...
        fun findFunctiondef(): FunctiondefContext? =
            getRuleContext(solver.getType("FunctiondefContext"), 0)

        fun findPrefixexp(): PrefixexpContext? =
            getRuleContext(solver.getType("PrefixexpContext"), 0)

        fun findTableconstructor(): TableconstructorContext? =
            getRuleContext(solver.getType("TableconstructorContext"), 0)

        fun findOperatorUnary(): OperatorUnaryContext? =
            getRuleContext(solver.getType("OperatorUnaryContext"), 0)

        fun findExp(): List<ExpContext> = getRuleContexts(solver.getType("ExpContext"))
        fun findExp(i: Int): ExpContext? = getRuleContext(solver.getType("ExpContext"), i)
        fun findLambdadef(): LambdadefContext? =
            getRuleContext(solver.getType("LambdadefContext"), 0)

        fun findOperatorPower(): OperatorPowerContext? =
            getRuleContext(solver.getType("OperatorPowerContext"), 0)

        fun findOperatorMulDivMod(): OperatorMulDivModContext? =
            getRuleContext(solver.getType("OperatorMulDivModContext"), 0)

        fun findOperatorAddSub(): OperatorAddSubContext? =
            getRuleContext(solver.getType("OperatorAddSubContext"), 0)

        fun findOperatorStrcat(): OperatorStrcatContext? =
            getRuleContext(solver.getType("OperatorStrcatContext"), 0)

        fun findOperatorComparison(): OperatorComparisonContext? =
            getRuleContext(solver.getType("OperatorComparisonContext"), 0)

        fun findOperatorAnd(): OperatorAndContext? =
            getRuleContext(solver.getType("OperatorAndContext"), 0)

        fun findOperatorOr(): OperatorOrContext? =
            getRuleContext(solver.getType("OperatorOrContext"), 0)

        fun findOperatorBitwise(): OperatorBitwiseContext? =
            getRuleContext(solver.getType("OperatorBitwiseContext"), 0)
    ...
    open class PrefixexpContext : ParserRuleContext {
        ...
        fun findNameAndArgs(): List<NameAndArgsContext> =
            getRuleContexts(solver.getType("NameAndArgsContext"))

        fun findNameAndArgs(i: Int): NameAndArgsContext? =
            getRuleContext(solver.getType("NameAndArgsContext"), i)
    ...
    open class LvarContext : ParserRuleContext {
        ...
        fun NAME(): TerminalNode? = getToken(LuaParser.Tokens.NAME.id, 0)
        fun findExp(): ExpContext? = getRuleContext(solver.getType("ExpContext"), 0)
        fun findVarSuffix(): List<VarSuffixContext> =
            getRuleContexts(solver.getType("VarSuffixContext"))

        fun findVarSuffix(i: Int): VarSuffixContext? =
            getRuleContext(solver.getType("VarSuffixContext"), i)
    ...
    open class TableconstructorContext : ParserRuleContext {
        ...
        fun findFieldlist(): FieldlistContext? =
            getRuleContext(solver.getType("FieldlistContext"), 0)
        ...
        override fun <T> accept(visitor: ParseTreeVisitor<out T>): T {
            if (visitor is LuaVisitor) return (visitor as LuaVisitor<out T>).visitTableconstructor(
                this
            )
            else return visitor.visitChildren(this)!!
        }
    ...
    open class FieldlistContext : ParserRuleContext {
        ...
        fun findFieldsep(): List<FieldsepContext> =
            getRuleContexts(solver.getType("FieldsepContext"))

        fun findFieldsep(i: Int): FieldsepContext? =
            getRuleContext(solver.getType("FieldsepContext"), i)
    ...
    open class OperatorComparisonContext : ParserRuleContext {
        ...
        override fun <T> accept(visitor: ParseTreeVisitor<out T>): T {
            if (visitor is LuaVisitor) return (visitor as LuaVisitor<out T>).visitOperatorComparison(
                this
            )
            else return visitor.visitChildren(this)!!
        }
    ...
    open class OperatorStrcatContext : ParserRuleContext {
        ...
        override fun <T> accept(visitor: ParseTreeVisitor<out T>): T {
            if (visitor is LuaVisitor) return (visitor as LuaVisitor<out T>).visitOperatorStrcat(
                this
            )
            else return visitor.visitChildren(this)!!
        }
    ...
    open class OperatorAddSubContext : ParserRuleContext {
        ...
        override fun <T> accept(visitor: ParseTreeVisitor<out T>): T {
            if (visitor is LuaVisitor) return (visitor as LuaVisitor<out T>).visitOperatorAddSub(
                this
            )
            else return visitor.visitChildren(this)!!
        }
    ...
    open class OperatorMulDivModContext : ParserRuleContext {
        ...
        override fun <T> accept(visitor: ParseTreeVisitor<out T>): T {
            if (visitor is LuaVisitor) return (visitor as LuaVisitor<out T>).visitOperatorMulDivMod(
                this
            )
            else return visitor.visitChildren(this)!!
        }
    ...
    open class OperatorBitwiseContext : ParserRuleContext {
        ...
        override fun <T> accept(visitor: ParseTreeVisitor<out T>): T {
            if (visitor is LuaVisitor) return (visitor as LuaVisitor<out T>).visitOperatorBitwise(
                this
            )
            else return visitor.visitChildren(this)!!
        }
