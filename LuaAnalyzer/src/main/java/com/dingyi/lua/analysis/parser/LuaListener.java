...
public interface LuaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code defaultStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void enterDefaultStat(LuaParser.DefaultStatContext ctx);
	/**
	 * Exit a parse tree produced by the {@code defaultStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitDefaultStat(LuaParser.DefaultStatContext ctx);
	/**
	 * Enter a parse tree produced by the {@code varListStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void enterVarListStat(LuaParser.VarListStatContext ctx);
	/**
	 * Exit a parse tree produced by the {@code varListStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitVarListStat(LuaParser.VarListStatContext ctx);
	/**
	 * Enter a parse tree produced by the {@code functionCallStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void enterFunctionCallStat(LuaParser.FunctionCallStatContext ctx);
	/**
	 * Exit a parse tree produced by the {@code functionCallStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitFunctionCallStat(LuaParser.FunctionCallStatContext ctx);
	/**
	 * Enter a parse tree produced by the {@code labelStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void enterLabelStat(LuaParser.LabelStatContext ctx);
	/**
	 * Exit a parse tree produced by the {@code labelStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitLabelStat(LuaParser.LabelStatContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterContinueStat(LuaParser.ContinueStatContext ctx);
	/**
	 * Exit a parse tree produced by the {@code continueStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitContinueStat(LuaParser.ContinueStatContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterFunctionDefStat(LuaParser.FunctionDefStatContext ctx);
	/**
	 * Exit a parse tree produced by the {@code functionDefStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitFunctionDefStat(LuaParser.FunctionDefStatContext ctx);
	/**
	 * Enter a parse tree produced by the {@code localFunctionDefStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void enterLocalFunctionDefStat(LuaParser.LocalFunctionDefStatContext ctx);
	/**
	 * Exit a parse tree produced by the {@code localFunctionDefStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitLocalFunctionDefStat(LuaParser.LocalFunctionDefStatContext ctx);
	/**
	 * Enter a parse tree produced by the {@code localVarListStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void enterLocalVarListStat(LuaParser.LocalVarListStatContext ctx);
	/**
	 * Exit a parse tree produced by the {@code localVarListStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitLocalVarListStat(LuaParser.LocalVarListStatContext ctx);
	/**
	 * Enter a parse tree produced by the {@code switchStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void enterSwitchStat(LuaParser.SwitchStatContext ctx);
	/**
	 * Exit a parse tree produced by the {@code switchStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitSwitchStat(LuaParser.SwitchStatContext ctx);
	/**
	 * Enter a parse tree produced by the {@code whenStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void enterWhenStat(LuaParser.WhenStatContext ctx);
	/**
	 * Exit a parse tree produced by the {@code whenStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitWhenStat(LuaParser.WhenStatContext ctx);
	/**
	 * Enter a parse tree produced by the {@code lambdaStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void enterLambdaStat(LuaParser.LambdaStatContext ctx);
	/**
	 * Exit a parse tree produced by the {@code lambdaStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitLambdaStat(LuaParser.LambdaStatContext ctx);
	/**
	 * Enter a parse tree produced by the {@code deferStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void enterDeferStat(LuaParser.DeferStatContext ctx);
	/**
	 * Exit a parse tree produced by the {@code deferStat}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitDeferStat(LuaParser.DeferStatContext ctx);
	/**
	 * Enter a parse tree produced by the {@code comment}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void enterComment(LuaParser.CommentContext ctx);
	/**
	 * Exit a parse tree produced by the {@code comment}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitComment(LuaParser.CommentContext ctx);
	/**
	 * Enter a parse tree produced by the {@code lineComment}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void enterLineComment(LuaParser.LineCommentContext ctx);
	/**
	 * Exit a parse tree produced by the {@code lineComment}
	 * labeled alternative in {@link LuaParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitLineComment(LuaParser.LineCommentContext ctx);
	/**
	 * Enter a parse tree produced by {@link LuaParser#ifbody}.
	 * @param ctx the parse tree
	 */
	void enterIfbody(LuaParser.IfbodyContext ctx);
	/**
	 * Exit a parse tree produced by {@link LuaParser#ifbody}.
	 * @param ctx the parse tree
	 */
	void exitIfbody(LuaParser.IfbodyContext ctx);
	/**
	 * Enter a parse tree produced by {@link LuaParser#elseifbody}.
	 * @param ctx the parse tree
	 */
	void enterElseifbody(LuaParser.ElseifbodyContext ctx);
	/**
	 * Exit a parse tree produced by {@link LuaParser#elseifbody}.
	 * @param ctx the parse tree
	 */
	void exitElseifbody(LuaParser.ElseifbodyContext ctx);
	/**
	 * Enter a parse tree produced by {@link LuaParser#elsebody}.
	 * @param ctx the parse tree
	 */
	void enterElsebody(LuaParser.ElsebodyContext ctx);
	/**
	 * Exit a parse tree produced by {@link LuaParser#elsebody}.
	 * @param ctx the parse tree
	 */
	void exitElsebody(LuaParser.ElsebodyContext ctx);
	/**
	 * Enter a parse tree produced by {@link LuaParser#defaultbody}.
	 * @param ctx the parse tree
	 */
	void enterDefaultbody(LuaParser.DefaultbodyContext ctx);
	/**
	 * Exit a parse tree produced by {@link LuaParser#defaultbody}.
	 * @param ctx the parse tree
	 */
	void exitDefaultbody(LuaParser.DefaultbodyContext ctx);
	/**
	 * Enter a parse tree produced by {@link LuaParser#casebody}.
	 * @param ctx the parse tree
	 */
	void enterCasebody(LuaParser.CasebodyContext ctx);
	/**
	 * Exit a parse tree produced by {@link LuaParser#casebody}.
	 * @param ctx the parse tree
	 */
	void exitCasebody(LuaParser.CasebodyContext ctx);
	/**
	 * Enter a parse tree produced by {@link LuaParser#lambdabody}.
	 * @param ctx the parse tree
	 */
	void enterLambdabody(LuaParser.LambdabodyContext ctx);
	/**
	 * Exit a parse tree produced by {@link LuaParser#lambdabody}.
	 * @param ctx the parse tree
	 */
	void exitLambdabody(LuaParser.LambdabodyContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterLambdadef(LuaParser.LambdadefContext ctx);
	/**
	 * Exit a parse tree produced by {@link LuaParser#lambdadef}.
	 * @param ctx the parse tree
	 */
	void exitLambdadef(LuaParser.LambdadefContext ctx);
	/**
