 ...
 * @description:
 **/
object LuaLanguage : BaseLanguage(), EditorLanguage {
    ...
    private const val packageName = "coroutine|debug|io|luajava|math|os|package|string|table|utf8"
    ...
    private const val functionTarget = "$globalTarget|activity|import|task|$packageName"
