...
class CompileLibraryJavaTest(private val module: Module) : DefaultTask(module) {
    ...
    override suspend fun prepare(): Task.State {
        ...
        compileJavaDirectory.map {
            ...
            getTaskInput()
                .addInputDirectory(file)
        }


        getTaskInput().transformDirectoryToFile {
            it.isFile && it.name.endsWith("java") &&
                    it.name != "R.java" && it.path.contains("ap_generated_source").not()
        }
